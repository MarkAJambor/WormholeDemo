...
using UnityEngine;
    ...
    public class CreateIcoSphere
    {
        ...
        public GameObject Create(Material material, Transform parent, int recursion,Color Col)
        {
            recursionLevel = Mathf.Clamp(recursion, 1, 5);
            ...
            Color[] Colors = new Color[nVertices.Length];
